...
function render(){const c=document.getElementById('content');c.innerHTML=({visao:renderVisao,receber:renderReceber,cobranca:renderCobranca,pagar:renderPagar,resultado:renderResultado,previsao:renderPrevisao,avisos:renderAvisos,dp:renderDP,assembleias:renderAssembleias,cadastro:renderCadastro})[SEC]();

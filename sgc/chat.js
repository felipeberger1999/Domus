...
(function(){
  ...
  function intentRegua(){ botAfter(650,'A <b>régua de cobrança</b> define as etapas que o agente de Cobrança executa (lembrete antes do vencimento, cobrança no atraso, notificação…) e as mensagens personalizadas por morador. Tudo roda em <b>modo de teste</b> por enquanto — nada é enviado.').then(function(){ chips([_navChip('Abrir Agente de Cobrança','cobranca')]); }); }
